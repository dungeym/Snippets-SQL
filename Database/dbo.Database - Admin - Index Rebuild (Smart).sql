...
--=================================================================================================
-- Rebuild indexes according to the level of fragmentation.
-- - where fragmentation < @RebuildFragmentation then use REORGANISE.
-- - where fragmentation >= @RebuildFragmentation then use REBUILD.
--=================================================================================================
...
FETCH NEXT FROM My_Cursor INTO @Object_id, @Index_id, @PartitionNumber, @AvgFragmentation, @PageCount, @LastUpdated
